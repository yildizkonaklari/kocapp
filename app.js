...
function updateUIForLoggedInUser(user) {
    ...
    if(document.getElementById("userProfileArea")) document.getElementById("userProfileArea").onclick = () => showProfileModal(user);
    if(document.getElementById("logoutButton")) document.getElementById("logoutButton").onclick = () => signOut(auth).then(() => window.location.href = 'login.html');
...
document.querySelectorAll('.close-modal-btn, #closeModalButton, #closeProfileModalButton, #cancelModalButton').forEach(btn => {
...
// ... (Diğer save butonları buraya eklenecek) ...
